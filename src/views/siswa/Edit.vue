...
export default {
    setup() {
        ...
        onMounted(() => {
            axios.get(`http://siswa-app.test/api/siswa/${route.params.id}`)
            .then((result) => {
                siswa.nama = result.data.data.nama;
                siswa.kelas = result.data.data.kelas;
                siswa.no_absen = result.data.data.no_absen;                
                siswa.jurusan = result.data.data.jurusan;
                siswa.deskripsi = result.data.data.deskripsi;
        ...
        function update() {
            axios.put(
                `http://siswa-app.test/api/siswa/${route.params.id}`,
                siswa
            )
            .then(() => {
                router.push({
